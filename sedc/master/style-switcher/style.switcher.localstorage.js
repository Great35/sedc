...
if (typeof localStorage !== "undefined") {
    if (localStorage.getItem('porto-skin.html') !== null && !document.querySelector('html').hasAttribute('data-style-switcher-options')) {

        var css = localStorage.getItem('porto-skin.html'),
