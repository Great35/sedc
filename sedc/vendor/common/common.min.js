...
if (! function(p) {
        p.extend({
            browserSelector: function() {
                ...
                var o = "ontouchstart" in window || navigator.msMaxTouchPoints,
                    ...
                    d = [!/opera|webtv/i.test(i) && /msie\s(\d)/.test(i) ? "ie ie" + parseFloat(navigator.appVersion.split("MSIE")[1]) : e("firefox/2") ? s + " ff2" : e("firefox/3.5") ? s + " ff3 ff3_5" : e("firefox/3") ? s + " ff3" : e("gecko/index.html") ? s : e("opera") ? r + (/version\/(\d+)/.test(i) ? " " + r + RegExp.jQuery1 : /opera(\s|\/)(\d+)/.test(i) ? " " + r + RegExp.jQuery2 : "") : e("konqueror") ? "konqueror" : e("chrome") ? n + " chrome" : e("iron") ? n + " iron" : e("applewebkit/index.html") ? n + " " + a + (/version\/(\d+)/.test(i) ? " " + a + RegExp.jQuery1 : "") : e("mozilla/index.html") ? s : "", e("j2me") ? "mobile" : e("iphone") ? "iphone" : e("ipod") ? "ipod" : e("mac") || e("darwin") ? "mac" : e("webtv") ? "webtv" : e("win") ? "win" : e("freebsd") ? "freebsd" : e("x11") || e("linux") ? "linux" : "", "js"];
    ...
    }), $("html").hasClass("disable-onload-scroll") || !window.location.hash || ["#*"].includes(window.location.hash) || (window.scrollTo(0, 0), $(window).on("load", function() {
        setTimeout(function() {
    ...
    }(jQuery), jQuery(".image-hotspot").append('<span class="ring"></span>').append('<span class="circle"></span>'), function(o) {
        if (o("body[data-plugin-page-transition]").get(0)) {
            var i = !1;
            o(document).on("click", "a", function(t) {
                i = o(this)
            }), o(window).on("beforeunload", function(t) {
                var e = i.attr("href");
                0 == e.indexOf("mailto:") || 0 == e.indexOf("tel:") || i.data("rm-from-transition") || o("body").addClass("page-transition-active")
            }), o(window).on("pageshow", function(t) {
                t.persisted && o("body").removeClass("page-transition-active")
            })
        }
    }(jQuery), function(e) {
        ...
        function d(t) {
            ...
            return e.each(function() {
                ...
                null !== o && Math.floor(Math.abs(i - e)) <= 1 ? s[s.length - 1] = o.add(t) : s.push(t), i = e
            }), s
        }
        ...
        function h(t) {
            ...
            if (t.parents(".word-rotator").hasClass("type")) {
                ...
                }(t.find("i").eq(0), t, i, s), m(e.find("i").eq(0), e, i, s)
            } else t.parents(".word-rotator").hasClass("clip") ? t.parents(".word-rotator-words").stop(!0, !0).animate({
                width: "2px"
            }, u, function() {
                g(t, e), f(e)
            }) : t.parents(".word-rotator").hasClass("loading-bar") ? (t.parents(".word-rotator-words").removeClass("is-loading"), g(t, e), setTimeout(function() {
                h(e)
            }, l), setTimeout(function() {
                t.parents(".word-rotator-words").addClass("is-loading")
            }, c)) : (g(t, e), setTimeout(function() {
                h(e)
            }, r))
        }

        function f(t, e) {
            t.parents(".word-rotator").hasClass("type") ? (m(t.find("i").eq(0), t, !1, e), t.addClass("is-visible").removeClass("is-hidden")) : t.parents(".word-rotator").hasClass("clip") && (document.hasFocus() ? t.parents(".word-rotator-words").stop(!0, !0).animate({
                width: t.outerWidth() + 10
            }, u, function() {
                setTimeout(function() {
                    h(t)
                }, o)
            }) : (t.parents(".word-rotator-words").stop(!0, !0).css("width", t.outerWidth() + 10), h(t)))
        }
        ...
        function m(t, e, o, i) {
            t.addClass("in").removeClass("out"), t.is(":last-child") ? (e.parents(".word-rotator").hasClass("type") && setTimeout(function() {
                ...
                h(e)
            }, r), e.closest(".word-rotator").hasClass("type") || e.closest(".word-rotator-words").stop(!0, !0).animate({
                width: e.outerWidth()
            })) : setTimeout(function() {
                m(t.next(), e, o, i)
            }, i)
    ...
    var t = {
        ...
        build: function() {
            ...
            o(window).height() - o(".header-body").height() < t ? (o("#footer").removeClass("footer-reveal"), o("body").css("margin-bottom", 0)) : (o("#footer").addClass("footer-reveal"), o("body").css("margin-bottom", t))
        },
        events: function() {
            var t = this,
                e = o(window);
