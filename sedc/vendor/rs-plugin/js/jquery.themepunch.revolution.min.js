...
! function(jQuery, undefined) {
    ...
    var _ISM = _R.is_mobile(),
        ...
        getScriptLocation = function(e) {
            var i = new RegExp("themepunch.revolution.min.html", "gi"),
                t = "";
            return jQuery("script").each(function() {
                var e = jQuery(this).attr("src");
                e && e.match(i) && (t = e)
            }), t = (t = (t = t.replace("jquery.themepunch.revolution.min.html", "")).replace("jquery.themepunch.revolution.html", "")).split("?")[0]
        },
        ...
        abstorel = function(e, i) {
            var t = e.split("index.html"),
                a = i.split("index.html");
            t.pop();
            for (var n = 0; n < a.length; n++) "." != a[n] && (".." == a[n] ? t.pop() : t.push(a[n]));
            return t.join("index.html")
        },
            ...
            o.find("img,.defaultimg, .tp-svg-layer").each(function() {
                ...
                if (e.data("loaded") === undefined && t !== undefined && t.progress && t.progress.match(/loaded/g)) {
                    if (e.attr("src", t.src), "img" == t.type)
                        if (e.hasClass("defaultimg")) _R.isIE(8) ? defimg.attr("src", t.src) : -1 == t.src.indexOf("images/transparent.html") && -1 == t.src.indexOf("assets/transparent.html") || e.data("bgcolor") === undefined ? e.css({
    ...
    jQuery.extend(!0, I, {
        ...
        checkVideoApis: function(e, t, a) {
            ...
            if ((null != e.data("vimeoid") || 0 < e.find("iframe").length && 0 < e.find("iframe").attr("src").toLowerCase().indexOf("vimeo")) && (t.vimeoapineeded = !0), (null != e.data("vimeoid") || 0 < e.find("iframe").length && 0 < e.find("iframe").attr("src").toLowerCase().indexOf("vimeo")) && 0 == a.addedvim) {
                ...
                n.src = "../player.vimeo.com/api/player.js", jQuery("head").find("*").each(function() {
